...
$(document).on('click', '#assign_recruitmethod', function () {
	if ($("#check_assign_recruitmethod").is(":checked")) {
		var jobid 		  = $("#check_assign_recruitmethod").data('id');
		var branch_id     = $("#check_assign_recruitmethod").data('branchid');
		var department_id = $("#check_assign_recruitmethod").data('deptid');
	}
