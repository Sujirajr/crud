...
<div class="col-lg-8">
	<button type="button" id="Customerdetail_submit" class="btn btn-secondary float-right mr-2 Updation_information"><?php echo isset($_REQUEST['id']) ? 'Update' : 'Submit' ?></button>
