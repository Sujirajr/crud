 ...
 <?php $this->load->view("common/header"); ?>
						<link href="<?php echo back_skin; ?>assets/css/pages/error/error-6.css" rel="stylesheet" type="text/css" />
...
<div class="kt-grid kt-grid--ver kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v6" style="background-image: url(<?php echo back_skin; ?>assets/media/error/bg6.jpg);">
