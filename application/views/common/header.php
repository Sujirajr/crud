...
<html lang="en" ng-app="my_app">
	...
	<head>
		<base href="">
		<meta charset="utf-8" />
		<title><?php echo $title;?> | Qzolve - Payroll</title>
		...
		<link href="<?php echo back_skin; ?>assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="<?php echo base_url; ?>dashboard">
					<img alt="Logo" src="<?php echo back_skin; ?>assets/media/logos/logo-light.png" />
				</a>
			</div>
...
-->
     ...
     <?php $this->load->view("common/fixed_header"); ?>
